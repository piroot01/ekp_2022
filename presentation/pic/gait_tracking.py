...
data = numpy.genfromtxt("output.csv", delimiter=",")

sample_rate = 100  # 400 Hz

# Split the data into subarrays.
timestamp = (data[:, 0] - data[0, 0]) / 1000000
accelerometer = data[:, 1:4] * 4.0 / 32767.0 
gyroscope = data[:, 4:7] * 1000.0 / 32767.0
threshold = 0.5
n = 5
...
ahrs.settings = imufusion.Settings(0.05,  # gain
                                   10,  # acceleration rejection
                                   0,  # magnetic rejection
                                   n * sample_rate)  # rejection timeout = 5 seconds
